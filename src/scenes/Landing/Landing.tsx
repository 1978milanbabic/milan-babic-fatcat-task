...
import { Card } from '@app-root/components/Card.tsx';
import { cards, vscodeProjectLink } from '@app-root/scenes/Landing/cards.ts';
    ...
    >
      ...
      >
        ...
        >
          ...
          <span className={clsx('text-primary')}>Homework Task Page</span>
